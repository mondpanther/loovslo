---
title:  LOO, LO & LOX
subtitle: Monte Carlo Simulations of Leave one Out, Leave (more than one) Out and Leave Out with Extra Control (LOX) estimators
output: 
  html_document:
    css: style.css
runtime: shiny
...
We illustrate two strategies to address these criticisms (both used in HMMS) and provide Monte-Carlo evidence on their effectiveness.
